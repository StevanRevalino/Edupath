...
export default function SimpleHeroSection({ title }: SimpleHeroSectionProps) {
  return (
    <div className="absolute -top-20 left-0 w-full h-48 sm:h-64 md:h-80 lg:h-96 z-[1]">
      ...
      {/* Overlay Content */}
      <div className="absolute inset-0 flex items-center justify-start pl-[20%] sm:pl-[30%] md:pl-[40%]">
        <div className="flex pt-10 sm:pt-16 md:pt-20 items-center gap-2 sm:gap-4 md:gap-6">
          <h1 className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold drop-shadow-lg text-right leading-tight truncate">
            {title}
          </h1>

...
export class BeasiswaController {
  constructor() {
    ...
    this.getAllBeasiswa = this.getAllBeasiswa.bind(this);
    this.getBeasiswaById = this.getBeasiswaById.bind(this);
    this.createBeasiswa = this.createBeasiswa.bind(this);
    this.updateBeasiswa = this.updateBeasiswa.bind(this);
    this.deleteBeasiswa = this.deleteBeasiswa.bind(this);
  }
  // Get all beasiswa
  getAllBeasiswa = async (req: Request, res: Response) => {
    try {
  ...
  // Get beasiswa by ID
  getBeasiswaById = async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
  ...
  // Create new beasiswa
  createBeasiswa = async (req: Request, res: Response) => {
    try {
      ...
      try {
        ...
        console.log(
          `Sent beasiswa notification to ${students.length} students`
        );
  ...
  // Update beasiswa
  updateBeasiswa = async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
      const { title, image_url, link } = req.body;
  ...
  // Delete beasiswa
  deleteBeasiswa = async (req: Request, res: Response) => {
    try {
      const { id } = req.params;

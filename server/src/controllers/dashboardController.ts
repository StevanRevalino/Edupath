...
export class DashboardController {
  constructor() {
    ...
    this.getWeeklyConsultations = this.getWeeklyConsultations.bind(this);
  ...
  getUpcomingConsultations = async (req: Request, res: Response) => {
    try {
      const adminId = req.user?.user_id;
  ...
  // Get Recent Chats
  getRecentChats = async (req: Request, res: Response) => {
    try {
      const adminId = req.user?.user_id;
  ...
  getWeeklyConsultations = async (req: Request, res: Response) => {
    try {
  ...
  triggerAutoComplete = async (req: Request, res: Response) => {
    try {
